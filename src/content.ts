...
export const content = {
  en: {
    ...
    hero: {
      ...
      title2: 'So do we.',
      sub: "Cyvard tests your systems the way a real attacker would — now one armed with AI — and shows you exactly where you're exposed, before someone less friendly finds the same gaps.",
    ...
    spoof: {
      ...
      title: "This took three seconds — and it's the easy stuff.",
    ...
    threat: {
      ...
      post: " — no longer holds. Automation doesn't care about your size.",
      stats: [
    ...
    services: {
      ...
      items: [
        ...
        ['Security assessments', 'A clear read on your posture — what is exposed, how bad it is, and what to fix first.'],
        ['Email & domain spoofing', 'SPF, DKIM and DMARC gaps that let anyone send mail in your name. The fast, no-touch entry point.'],
        ['GDPR data exposure', 'Open databases, leaky APIs, misconfigured cloud — the findings that become a compliance case.'],
      ],
    },
    pricing: {
      eyebrow: 'Pricing',
    ...
    track: {
      ...
      role: 'Founder, Cyvard',
      stats: [
        ['$60M+', 'Combined value-at-risk uncovered across engagements — individual findings exposing $16M–27M asset pools.'],
    ...
    hero: {
      ...
      title2: 'Niin mekin.',
      sub: 'Cyvard testaa järjestelmäsi kuten oikea hyökkääjä, nyt tekoälyn avustamana, ja näyttää tarkalleen missä olet alttiina, ennen kuin joku vähemmän ystävällinen löytää samat aukot.',
    ...
    spoof: {
      ...
      title: 'Tämä vei kolme sekuntia, ja se on helppo osuus.',
      body: 'Ennen kuin kosketamme mitään, paljon on jo näkyvissä ulospäin: verkkotunnus jonka nimissä kuka tahansa voi lähettää postia, hallintapaneeli ilman kirjautumista, avoimeksi jäänyt pilvitallennus. Näytämme mitä hyökkääjä näkee ensimmäisenä, veloituksetta.',
    },
    threat: {
    ...
    video: {
      ...
      body: 'Miksi henkilö, jolla ei ole juuri teknistä osaamista, pystyy tekoälyn avulla tekemään sen mihin ennen tarvittiin vuosien kokemus, ja miksi datasi ei ole koskaan ollut näin alttiina.',
    },
    services: {
      eyebrow: 'Mitä teemme',
      title: 'Löydämme aukot ja annamme korjausohjeet.',
      items: [
        ['Penetraatiotestaus', 'Verkkosovellukset, rajapinnat ja infrastruktuuri, testattuna kuten oikea hyökkääjä ne lähestyisi.'],
        ['Tietoturva-arvioinnit', 'Selkeä kuva tilanteestasi: mikä on alttiina, kuinka vakavaa se on ja mitä korjata ensin.'],
        ['Sähköpostin väärentäminen', 'SPF-, DKIM- ja DMARC-aukot, joiden avulla kuka tahansa voi lähettää postia nimissäsi. Nopea ja koskematon aloituskohta.'],
        ['GDPR-tietovuodot', 'Avoimet tietokannat, vuotavat rajapinnat, väärin konfiguroitu pilvi, löydökset joista tulee tietosuojatapaus.'],
      ],
    },
    pricing: {
      eyebrow: 'Hinnoittelu',
      title: 'Kiinteät aloituspisteet, rehellisesti rajattuna puhelussa.',
      subtitle: 'Aloita pienestä, skaalaa tarpeen mukaan.',
      ...
      tiers: [
        ...
        { name: 'Guardian — jatkuva vahti', price: 'alk. 390 €', unit: '/kk', sub: 'kuukausittain jatkuva', blurb: 'Täysi jatkuva suhde — valvottuna jatkuvasti ja uudelleentestattuna neljännesvuosittain.', featured: false, features: ['Jatkuva hyökkäyspinnan valvonta', 'Täysi uusintatesti neljännesvuosittain', 'Asiantuntija tavoitettavissa, priorisoitu vaste', 'Uudet altistumat kiinni ajoissa'] },
        ...
        { name: 'Web- & API-pentest', price: 'alk. 2 900 €', unit: '', sub: 'projektikohtainen', blurb: 'Syvä toimeksianto — reitit jotka oikeasti yltävät dataasi.', featured: false, features: ['Autentikoitu, syvällinen testaus', 'Rikkinäinen autentikointi, IDOR, injektiot, logiikkavirheet', 'Selkeä raportti + korjaus jokaiseen löydökseen', 'Yksi veloitukseton uusintatesti sulkemisen varmistamiseksi', 'Sopimuksella, rajattu ja safe-harbour'] },
      ],
    },
    track: {
      eyebrow: 'Näytöt',
      ...
      intro:
        'Ennen Cyvardia löysin vuosien ajan todellisia, hyödynnettäviä haavoittuvuuksia elävistä krypto- ja DeFi-järjestelmistä, kaikkein vihamielisimmästä ympäristöstä, jossa yksi virhe siirtää rahaa välittömästi. Sama kurinalaisuus kohdistuu suoraan verkkosivuusi, rajapintoihisi ja pilveesi.',
      ...
      stats: [
        ...
        ['~96k', 'Henkilö- ja compliance-tietuetta paljastui yhdestä tunnistamattomasta rajapinnasta, juuri sellainen vuoto josta tulee tietosuojailmoitus.'],
        ['0', 'Vääriä positiivisia toimitettu. Jokainen löydös on käsin varmennettu ja todistettu; ei-ongelmat pudotetaan, ei paisutella.'],
      ],
      findings: [
        ['~27 M€', 'Kassan tyhjennysreitti', 'Valtuutusvirhe avasi reitin tyhjentää ~27 M€:n omaisuuserä. Todistettu elävällä forkilla ja korjattu tiimin kanssa.'],
        ...
        ['Haltuunotto', 'Roikkuva infrastruktuuri', 'Unohtunut, roikkuva aliverkkotunnus olisi kenen tahansa vallattavissa ja aseistettavissa käyttäjien kalasteluun luotetulta verkkotunnukselta.'],
        ['Vuotavat avaimet', 'Näkyvillä tuotannossa', 'Vuotaneita API-avaimia toimitetussa koodissa, täydet source mapit tuotannossa, ja julkisesti listattava pilviämpäri käyttäjädataa, hiljaiset vuodot joita kukaan ei vahdi.'],
      ],
      note: 'Anonymisoitu asiakasluottamuksen suojaamana. En nimeä asiakasta enkä julkaise hyödynnettävää yksityiskohtaa, ja juuri se pidättyväisyys on se mitä palkkaat.',
    },
    cta: {
      title: 'Katso mitä järjestelmäsi paljastavat.',
      body: 'Aloita ilmaisella, koskemattomalla sähköpostin tietoturvan tarkistuksella. Jos se on väärennettävissä, tiedät sen minuuteissa, ja niin tietäisi hyökkääjäkin.',
